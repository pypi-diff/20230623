# Comparing `tmp/gregory_online-0.3.4.tar.gz` & `tmp/gregory_online-0.3.5.tar.gz`
...
### Comparing `gregory_online-0.3.4/gregory_online/config.py` & `gregory_online-0.3.5/gregory_online/config.py`
