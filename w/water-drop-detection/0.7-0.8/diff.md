# Comparing `tmp/water_drop_detection-0.7.tar.gz` & `tmp/water_drop_detection-0.8.tar.gz`
...
## Comparing `water_drop_detection-0.7.tar` & `water_drop_detection-0.8.tar`
...
### Comparing `water_drop_detection-0.7/PKG-INFO` & `water_drop_detection-0.8/PKG-INFO`
...
### Comparing `water_drop_detection-0.7/README.md` & `water_drop_detection-0.8/README.md`

 * *Files identical despite different names*

### Comparing `water_drop_detection-0.7/setup.py` & `water_drop_detection-0.8/setup.py`
...
### Comparing `water_drop_detection-0.7/water_drop_detection.egg-info/PKG-INFO` & `water_drop_detection-0.8/water_drop_detection.egg-info/PKG-INFO`
