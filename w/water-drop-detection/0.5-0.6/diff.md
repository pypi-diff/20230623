# Comparing `tmp/water_drop_detection-0.5.tar.gz` & `tmp/water_drop_detection-0.6.tar.gz`
...
## Comparing `water_drop_detection-0.5.tar` & `water_drop_detection-0.6.tar`
...
### Comparing `water_drop_detection-0.5/PKG-INFO` & `water_drop_detection-0.6/PKG-INFO`
...
### Comparing `water_drop_detection-0.5/README.md` & `water_drop_detection-0.6/README.md`

 * *Files identical despite different names*

### Comparing `water_drop_detection-0.5/setup.py` & `water_drop_detection-0.6/setup.py`
...
### Comparing `water_drop_detection-0.5/water_drop_detection.egg-info/PKG-INFO` & `water_drop_detection-0.6/water_drop_detection.egg-info/PKG-INFO`
