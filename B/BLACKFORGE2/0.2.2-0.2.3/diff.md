# Comparing `tmp/BLACKFORGE2-0.2.2.tar.gz` & `tmp/BLACKFORGE2-0.2.3.tar.gz`
...
## Comparing `BLACKFORGE2-0.2.2.tar` & `BLACKFORGE2-0.2.3.tar`
...
### Comparing `BLACKFORGE2-0.2.2/BLACKFORGE2/FORGE.py` & `BLACKFORGE2-0.2.3/BLACKFORGE2/FORGE.py`
...
### Comparing `BLACKFORGE2-0.2.2/LICENSE` & `BLACKFORGE2-0.2.3/LICENSE`

 * *Files identical despite different names*

### Comparing `BLACKFORGE2-0.2.2/README.rst` & `BLACKFORGE2-0.2.3/README.rst`
