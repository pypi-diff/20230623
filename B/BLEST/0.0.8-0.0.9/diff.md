# Comparing `tmp/BLEST-0.0.8.tar.gz` & `tmp/BLEST-0.0.9.tar.gz`
...
+gzip compressed data, was "BLEST-0.0.9.tar", last modified: Fri Jun 23 02:56:07 2023, max compression
```

## Comparing `BLEST-0.0.8.tar` & `BLEST-0.0.9.tar`
...
+drwxr-xr-x   0 admin      (501) wheel        (0)        0 2023-06-23 02:56:07.794995 BLEST-0.0.9/
+drwxr-xr-x   0 admin      (501) wheel        (0)        0 2023-06-23 02:56:07.794234 BLEST-0.0.9/BLEST.egg-info/
+-rw-r--r--   0 admin      (501) wheel        (0)     4125 2023-06-23 02:56:07.000000 BLEST-0.0.9/BLEST.egg-info/PKG-INFO
+-rw-r--r--   0 admin      (501) wheel        (0)      170 2023-06-23 02:56:07.000000 BLEST-0.0.9/BLEST.egg-info/SOURCES.txt
+-rw-r--r--   0 admin      (501) wheel        (0)        1 2023-06-23 02:56:07.000000 BLEST-0.0.9/BLEST.egg-info/dependency_links.txt
+-rw-r--r--   0 admin      (501) wheel        (0)        8 2023-06-23 02:56:07.000000 BLEST-0.0.9/BLEST.egg-info/requires.txt
+-rw-r--r--   0 admin      (501) wheel        (0)        1 2023-06-23 02:56:07.000000 BLEST-0.0.9/BLEST.egg-info/top_level.txt
+-rw-r--r--   0 admin      (501) wheel        (0)     1061 2023-06-11 20:34:38.000000 BLEST-0.0.9/LICENSE
+-rw-r--r--   0 admin      (501) wheel        (0)     4125 2023-06-23 02:56:07.794658 BLEST-0.0.9/PKG-INFO
+-rw-r--r--   0 admin      (501) wheel        (0)     3369 2023-06-23 01:13:48.000000 BLEST-0.0.9/README.md
+-rw-r--r--   0 admin      (501) wheel        (0)       38 2023-06-23 02:56:07.795088 BLEST-0.0.9/setup.cfg
+-rw-r--r--   0 admin      (501) wheel        (0)     1039 2023-06-23 02:52:34.000000 BLEST-0.0.9/setup.py
```

### Comparing `BLEST-0.0.8/BLEST.egg-info/PKG-INFO` & `BLEST-0.0.9/BLEST.egg-info/PKG-INFO`
...
### Comparing `BLEST-0.0.8/LICENSE` & `BLEST-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `BLEST-0.0.8/PKG-INFO` & `BLEST-0.0.9/PKG-INFO`
...
### Comparing `BLEST-0.0.8/README.md` & `BLEST-0.0.9/README.md`

 * *Files identical despite different names*

### Comparing `BLEST-0.0.8/setup.py` & `BLEST-0.0.9/setup.py`
