# Comparing `tmp/cmon-ai-0.2.6.tar.gz` & `tmp/cmon-ai-0.38.5.tar.gz`
...
### Comparing `cmon-ai-0.2.6/LICENSE` & `cmon-ai-0.38.5/LICENSE`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/PKG-INFO` & `cmon-ai-0.38.5/PKG-INFO`
...
### Comparing `cmon-ai-0.2.6/README.md` & `cmon-ai-0.38.5/README.md`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/__init__.py` & `cmon-ai-0.38.5/cmon/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/checker.py` & `cmon-ai-0.38.5/cmon/checker.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/__init__.py` & `cmon-ai-0.38.5/cmon/clients/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/base/__init__.py` & `cmon-ai-0.38.5/cmon/clients/base/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/base/grpc.py` & `cmon-ai-0.38.5/cmon/clients/base/grpc.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/base/helper.py` & `cmon-ai-0.38.5/cmon/clients/base/helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/base/http.py` & `cmon-ai-0.38.5/cmon/clients/base/http.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/base/retry.py` & `cmon-ai-0.38.5/cmon/clients/base/retry.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/base/stream_rpc.py` & `cmon-ai-0.38.5/cmon/clients/base/stream_rpc.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/base/unary_rpc.py` & `cmon-ai-0.38.5/cmon/clients/base/unary_rpc.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/base/websocket.py` & `cmon-ai-0.38.5/cmon/clients/base/websocket.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/grpc.py` & `cmon-ai-0.38.5/cmon/clients/grpc.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/helper.py` & `cmon-ai-0.38.5/cmon/clients/helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/http.py` & `cmon-ai-0.38.5/cmon/clients/http.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/mixin.py` & `cmon-ai-0.38.5/cmon/clients/mixin.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/request/__init__.py` & `cmon-ai-0.38.5/cmon/clients/request/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/request/asyncio.py` & `cmon-ai-0.38.5/cmon/clients/request/asyncio.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/request/helper.py` & `cmon-ai-0.38.5/cmon/clients/request/helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/clients/websocket.py` & `cmon-ai-0.38.5/cmon/clients/websocket.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/constants.py` & `cmon-ai-0.38.5/cmon/constants.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/enums.py` & `cmon-ai-0.38.5/cmon/enums.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/excepts.py` & `cmon-ai-0.38.5/cmon/excepts.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/exporter.py` & `cmon-ai-0.38.5/cmon/exporter.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/helper.py` & `cmon-ai-0.38.5/cmon/helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/importer.py` & `cmon-ai-0.38.5/cmon/importer.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/jaml/__init__.py` & `cmon-ai-0.38.5/cmon/jaml/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/jaml/helper.py` & `cmon-ai-0.38.5/cmon/jaml/helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/jaml/parsers/__init__.py` & `cmon-ai-0.38.5/cmon/jaml/parsers/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/jaml/parsers/base.py` & `cmon-ai-0.38.5/cmon/jaml/parsers/base.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/jaml/parsers/deployment/legacy.py` & `cmon-ai-0.38.5/cmon/jaml/parsers/deployment/legacy.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/jaml/parsers/executor/legacy.py` & `cmon-ai-0.38.5/cmon/jaml/parsers/executor/legacy.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/jaml/parsers/flow/v1.py` & `cmon-ai-0.38.5/cmon/jaml/parsers/flow/v1.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/jaml/parsers/gateway/legacy.py` & `cmon-ai-0.38.5/cmon/jaml/parsers/gateway/legacy.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/logging/formatter.py` & `cmon-ai-0.38.5/cmon/logging/formatter.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/logging/logger.py` & `cmon-ai-0.38.5/cmon/logging/logger.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/logging/profile.py` & `cmon-ai-0.38.5/cmon/logging/profile.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/deployments/__init__.py` & `cmon-ai-0.38.5/cmon/orchestrate/deployments/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/deployments/config/docker_compose.py` & `cmon-ai-0.38.5/cmon/orchestrate/deployments/config/docker_compose.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/deployments/config/helper.py` & `cmon-ai-0.38.5/cmon/orchestrate/deployments/config/helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/deployments/config/k8s.py` & `cmon-ai-0.38.5/cmon/orchestrate/deployments/config/k8s.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/deployments/config/k8slib/kubernetes_deployment.py` & `cmon-ai-0.38.5/cmon/orchestrate/deployments/config/k8slib/kubernetes_deployment.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/deployments/config/k8slib/kubernetes_tools.py` & `cmon-ai-0.38.5/cmon/orchestrate/deployments/config/k8slib/kubernetes_tools.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/deployments/install_requirements_helper.py` & `cmon-ai-0.38.5/cmon/orchestrate/deployments/install_requirements_helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/flow/asyncio.py` & `cmon-ai-0.38.5/cmon/orchestrate/flow/asyncio.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/flow/base.py` & `cmon-ai-0.38.5/cmon/orchestrate/flow/base.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/flow/builder.py` & `cmon-ai-0.38.5/cmon/orchestrate/flow/builder.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/helper.py` & `cmon-ai-0.38.5/cmon/orchestrate/helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/orchestrator.py` & `cmon-ai-0.38.5/cmon/orchestrate/orchestrator.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/pods/__init__.py` & `cmon-ai-0.38.5/cmon/orchestrate/pods/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/pods/container.py` & `cmon-ai-0.38.5/cmon/orchestrate/pods/container.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/pods/container_helper.py` & `cmon-ai-0.38.5/cmon/orchestrate/pods/container_helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/pods/factory.py` & `cmon-ai-0.38.5/cmon/orchestrate/pods/factory.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/orchestrate/pods/helper.py` & `cmon-ai-0.38.5/cmon/orchestrate/pods/helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/__init__.py` & `cmon-ai-0.38.5/cmon/parsers/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/base.py` & `cmon-ai-0.38.5/cmon/parsers/base.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/client.py` & `cmon-ai-0.38.5/cmon/parsers/client.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/create.py` & `cmon-ai-0.38.5/cmon/parsers/create.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/deprecated.py` & `cmon-ai-0.38.5/cmon/parsers/deprecated.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/export.py` & `cmon-ai-0.38.5/cmon/parsers/export.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/flow.py` & `cmon-ai-0.38.5/cmon/parsers/flow.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/helper.py` & `cmon-ai-0.38.5/cmon/parsers/helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/orchestrate/base.py` & `cmon-ai-0.38.5/cmon/parsers/orchestrate/base.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/orchestrate/deployment.py` & `cmon-ai-0.38.5/cmon/parsers/orchestrate/deployment.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/orchestrate/pod.py` & `cmon-ai-0.38.5/cmon/parsers/orchestrate/pod.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/orchestrate/runtimes/container.py` & `cmon-ai-0.38.5/cmon/parsers/orchestrate/runtimes/container.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/orchestrate/runtimes/grpc_channel.py` & `cmon-ai-0.38.5/cmon/parsers/orchestrate/runtimes/grpc_channel.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/orchestrate/runtimes/head.py` & `cmon-ai-0.38.5/cmon/parsers/orchestrate/runtimes/head.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/orchestrate/runtimes/remote.py` & `cmon-ai-0.38.5/cmon/parsers/orchestrate/runtimes/remote.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/orchestrate/runtimes/runtime.py` & `cmon-ai-0.38.5/cmon/parsers/orchestrate/runtimes/runtime.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/orchestrate/runtimes/worker.py` & `cmon-ai-0.38.5/cmon/parsers/orchestrate/runtimes/worker.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/parsers/ping.py` & `cmon-ai-0.38.5/cmon/parsers/ping.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/proto/docarray_v1/pb/cmon_pb2.py` & `cmon-ai-0.38.5/cmon/proto/docarray_v1/pb/cmon_pb2.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/proto/docarray_v1/pb/cmon_pb2_grpc.py` & `cmon-ai-0.38.5/cmon/proto/docarray_v1/pb/cmon_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/proto/docarray_v1/pb2/cmon_pb2.py` & `cmon-ai-0.38.5/cmon/proto/docarray_v1/pb2/cmon_pb2.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/proto/docarray_v1/pb2/cmon_pb2_grpc.py` & `cmon-ai-0.38.5/cmon/proto/docarray_v1/pb2/cmon_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/proto/docarray_v2/pb/cmon_pb2.py` & `cmon-ai-0.38.5/cmon/proto/docarray_v2/pb/cmon_pb2.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/proto/docarray_v2/pb/cmon_pb2_grpc.py` & `cmon-ai-0.38.5/cmon/proto/docarray_v2/pb/cmon_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/proto/docarray_v2/pb2/cmon_pb2.py` & `cmon-ai-0.38.5/cmon/proto/docarray_v2/pb2/cmon_pb2.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/proto/docarray_v2/pb2/cmon_pb2_grpc.py` & `cmon-ai-0.38.5/cmon/proto/docarray_v2/pb2/cmon_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/proto/serializer.py` & `cmon-ai-0.38.5/cmon/proto/serializer.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/Python.gitignore` & `cmon-ai-0.38.5/cmon/resources/Python.gitignore`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/ci-vendors.json` & `cmon-ai-0.38.5/cmon/resources/ci-vendors.json`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/cmon.logo` & `cmon-ai-0.38.5/cmon/resources/cmon.logo`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/completions/cmon.bash` & `cmon-ai-0.38.5/cmon/resources/completions/cmon.bash`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/completions/cmon.fish` & `cmon-ai-0.38.5/cmon/resources/completions/cmon.fish`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/extra-requirements.txt` & `cmon-ai-0.38.5/cmon/resources/extra-requirements.txt`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/health_check/gateway.py` & `cmon-ai-0.38.5/cmon/resources/health_check/gateway.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/health_check/pod.py` & `cmon-ai-0.38.5/cmon/resources/health_check/pod.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/k8s/template/deployment-executor.yml` & `cmon-ai-0.38.5/cmon/resources/k8s/template/deployment-executor.yml`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/k8s/template/deployment-gateway.yml` & `cmon-ai-0.38.5/cmon/resources/k8s/template/deployment-gateway.yml`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/k8s/template/deployment-uses-after.yml` & `cmon-ai-0.38.5/cmon/resources/k8s/template/deployment-uses-after.yml`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/k8s/template/deployment-uses-before-after.yml` & `cmon-ai-0.38.5/cmon/resources/k8s/template/deployment-uses-before-after.yml`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/k8s/template/deployment-uses-before.yml` & `cmon-ai-0.38.5/cmon/resources/k8s/template/deployment-uses-before.yml`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/k8s/template/statefulset-executor.yml` & `cmon-ai-0.38.5/cmon/resources/k8s/template/statefulset-executor.yml`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/logging.default.yml` & `cmon-ai-0.38.5/cmon/resources/logging.default.yml`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/logging.docker.yml` & `cmon-ai-0.38.5/cmon/resources/logging.docker.yml`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/logging.quiet.yml` & `cmon-ai-0.38.5/cmon/resources/logging.quiet.yml`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/resources/logging.remote.yml` & `cmon-ai-0.38.5/cmon/resources/logging.remote.yml`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/schemas/__init__.py` & `cmon-ai-0.38.5/cmon/schemas/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/schemas/deployment.py` & `cmon-ai-0.38.5/cmon/schemas/deployment.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/schemas/flow.py` & `cmon-ai-0.38.5/cmon/schemas/flow.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/schemas/helper.py` & `cmon-ai-0.38.5/cmon/schemas/helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/schemas/meta.py` & `cmon-ai-0.38.5/cmon/schemas/meta.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/README.md` & `cmon-ai-0.38.5/cmon/serve/consensus/README.md`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/add_voter.go` & `cmon-ai-0.38.5/cmon/serve/consensus/add_voter.go`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/cmon-go-proto/cmon.pb.go` & `cmon-ai-0.38.5/cmon/serve/consensus/cmon-go-proto/cmon.pb.go`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/cmon-go-proto/cmon_grpc.pb.go` & `cmon-ai-0.38.5/cmon/serve/consensus/cmon-go-proto/cmon_grpc.pb.go`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/cmon.proto` & `cmon-ai-0.38.5/cmon/serve/consensus/cmon.proto`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/cmon_raft/cmonraft.go` & `cmon-ai-0.38.5/cmon/serve/consensus/cmon_raft/cmonraft.go`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/cmon_raft/executor_connection.go` & `cmon-ai-0.38.5/cmon/serve/consensus/cmon_raft/executor_connection.go`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/cmon_raft/fsm.go` & `cmon-ai-0.38.5/cmon/serve/consensus/cmon_raft/fsm.go`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/cmon_raft/rpc.go` & `cmon-ai-0.38.5/cmon/serve/consensus/cmon_raft/rpc.go`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/cmon_raft/snapshot.go` & `cmon-ai-0.38.5/cmon/serve/consensus/cmon_raft/snapshot.go`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/docarray-go-proto/docarray.pb.go` & `cmon-ai-0.38.5/cmon/serve/consensus/docarray-go-proto/docarray.pb.go`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/docarray.proto` & `cmon-ai-0.38.5/cmon/serve/consensus/docarray.proto`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/go.mod` & `cmon-ai-0.38.5/cmon/serve/consensus/go.mod`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/go.sum` & `cmon-ai-0.38.5/cmon/serve/consensus/go.sum`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/jraft.go` & `cmon-ai-0.38.5/cmon/serve/consensus/jraft.go`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/jraft.h` & `cmon-ai-0.38.5/cmon/serve/consensus/jraft.h`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/run.go` & `cmon-ai-0.38.5/cmon/serve/consensus/run.go`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/scripts/fetch-protos.sh` & `cmon-ai-0.38.5/cmon/serve/consensus/scripts/fetch-protos.sh`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/consensus/scripts/protogen.sh` & `cmon-ai-0.38.5/cmon/serve/consensus/scripts/protogen.sh`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/executors/__init__.py` & `cmon-ai-0.38.5/cmon/serve/executors/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/executors/decorators.py` & `cmon-ai-0.38.5/cmon/serve/executors/decorators.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/executors/metas.py` & `cmon-ai-0.38.5/cmon/serve/executors/metas.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/executors/run.py` & `cmon-ai-0.38.5/cmon/serve/executors/run.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/helper.py` & `cmon-ai-0.38.5/cmon/serve/helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/instrumentation/__init__.py` & `cmon-ai-0.38.5/cmon/serve/instrumentation/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/monitoring.py` & `cmon-ai-0.38.5/cmon/serve/monitoring.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/networking/__init__.py` & `cmon-ai-0.38.5/cmon/serve/networking/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/networking/connection_pool_map.py` & `cmon-ai-0.38.5/cmon/serve/networking/connection_pool_map.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/networking/connection_stub.py` & `cmon-ai-0.38.5/cmon/serve/networking/connection_stub.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/networking/instrumentation.py` & `cmon-ai-0.38.5/cmon/serve/networking/instrumentation.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/networking/replica_list.py` & `cmon-ai-0.38.5/cmon/serve/networking/replica_list.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/networking/sse.py` & `cmon-ai-0.38.5/cmon/serve/networking/sse.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/networking/utils.py` & `cmon-ai-0.38.5/cmon/serve/networking/utils.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/asyncio.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/asyncio.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/gateway/async_request_response_handling.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/gateway/async_request_response_handling.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/gateway/gateway.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/gateway/gateway.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/gateway/graph/topology_graph.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/gateway/graph/topology_graph.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/gateway/health_model.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/gateway/health_model.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/gateway/http_fastapi_app.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/gateway/http_fastapi_app.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/gateway/http_fastapi_app_docarrayv2.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/gateway/http_fastapi_app_docarrayv2.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/gateway/models.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/gateway/models.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/gateway/request_handling.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/gateway/request_handling.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/gateway/streamer.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/gateway/streamer.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/gateway/websocket_fastapi_app.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/gateway/websocket_fastapi_app.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/head/request_handling.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/head/request_handling.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/helper.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/monitoring.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/monitoring.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/servers/__init__.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/servers/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/servers/composite.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/servers/composite.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/servers/grpc.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/servers/grpc.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/servers/http.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/servers/http.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/servers/load_balancer.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/servers/load_balancer.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/servers/websocket.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/servers/websocket.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/worker/batch_queue.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/worker/batch_queue.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/worker/http_fastapi_app.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/worker/http_fastapi_app.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/runtimes/worker/request_handling.py` & `cmon-ai-0.38.5/cmon/serve/runtimes/worker/request_handling.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/stream/__init__.py` & `cmon-ai-0.38.5/cmon/serve/stream/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/serve/stream/helper.py` & `cmon-ai-0.38.5/cmon/serve/stream/helper.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/types/mixin.py` & `cmon-ai-0.38.5/cmon/types/mixin.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/types/request/__init__.py` & `cmon-ai-0.38.5/cmon/types/request/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/types/request/data.py` & `cmon-ai-0.38.5/cmon/types/request/data.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon/types/request/status.py` & `cmon-ai-0.38.5/cmon/types/request/status.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon_ai.egg-info/PKG-INFO` & `cmon-ai-0.38.5/cmon_ai.egg-info/PKG-INFO`
...
### Comparing `cmon-ai-0.2.6/cmon_ai.egg-info/SOURCES.txt` & `cmon-ai-0.38.5/cmon_ai.egg-info/SOURCES.txt`
...
@@ -1,16 +1,14 @@
 ...
 pyproject.toml
 setup.py
-Package_Installer/__init__.py
-Package_Installer/__main__.py
 cmon/__init__.py
 cmon/__main__.py
 cmon/_docarray.py
 cmon/checker.py
...
### Comparing `cmon-ai-0.2.6/cmon_cli/__init__.py` & `cmon-ai-0.38.5/cmon_cli/__init__.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon_cli/api.py` & `cmon-ai-0.38.5/cmon_cli/api.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon_cli/autocomplete.py` & `cmon-ai-0.38.5/cmon_cli/autocomplete.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon_cli/export.py` & `cmon-ai-0.38.5/cmon_cli/export.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/cmon_cli/lookup.py` & `cmon-ai-0.38.5/cmon_cli/lookup.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/extra-requirements.txt` & `cmon-ai-0.38.5/extra-requirements.txt`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/fastentrypoints.py` & `cmon-ai-0.38.5/fastentrypoints.py`

 * *Files identical despite different names*

### Comparing `cmon-ai-0.2.6/setup.py` & `cmon-ai-0.38.5/setup.py`
