# Comparing `tmp/mathpub-0.0.7.tar.gz` & `tmp/mathpub-0.0.8.tar.gz`
...
## Comparing `mathpub-0.0.7.tar` & `mathpub-0.0.8.tar`
...
### Comparing `mathpub-0.0.7/mathpub/page.py` & `mathpub-0.0.8/mathpub/page.py`
...
### Comparing `mathpub-0.0.7/mathpub/utils.py` & `mathpub-0.0.8/mathpub/utils.py`
